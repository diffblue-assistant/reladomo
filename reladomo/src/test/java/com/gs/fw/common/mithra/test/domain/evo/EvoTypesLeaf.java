...
public class EvoTypesLeaf extends EvoTypesLeafAbstract
{
    ...
    protected EvoTypesLeaf(MithraObject ref, EvoTypesLeafExtractors attribute)
	{
		super(ref, attribute);
	}

    public static EvoTypesLeaf managedInstance(MithraObject ref, EvoTypesLeafExtractors attributes)
    {
    ...
    public static class Builder
    {
        ...
        public EvoTypesLeaf build()
        {
            return new EvoTypesLeaf(this);
        }
