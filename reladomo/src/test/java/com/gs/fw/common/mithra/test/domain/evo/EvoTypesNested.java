...
public class EvoTypesNested extends EvoTypesNestedAbstract
{
    
    public EvoTypesNested()
	{
		super();
	}

	protected EvoTypesNested(MithraObject ref, EvoTypesNestedExtractors attributes)
	{
		super(ref, attributes);
	}

    public static EvoTypesNested managedInstance(MithraObject ref, EvoTypesNestedExtractors attributes)
    {
    ...
    private EvoTypesNested(Builder builder)
    {
        ...
        if (builder.evoTypesLeaf != null)
        {
            this.copyLeafEvo(builder.evoTypesLeaf);
        }
    }
    ...
    public static class Builder
    {
        ...
        private EvoTypesLeaf evoTypesLeaf;
        ...
        public EvoTypesNested build()
        {
            return new EvoTypesNested(this);
        }

        public Builder withEvoTypesLeaf(EvoTypesLeaf evoTypesLeaf)
        {
            this.evoTypesLeaf = evoTypesLeaf;
            return this;
        }
